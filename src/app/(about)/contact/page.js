...
export default function Contact() {
  return (
    <section className="w-full h-auto md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex-col flex md:flex-row items-center justify-center dark:text-light text-dark">
